...
namespace Olympics
{
    public partial class btnExcel : Form
    {
        ...
        private void ExceltFeltolt()
        {
            ...
            var filteredReult = from x in results where x.Year == (int)cbx.SelectedItem orderby x.Position select x;
            int aktsor = 2;
        ...
        {
            var filteredReult = from x in results where x.Year == (int)cbx.SelectedItem select x;
